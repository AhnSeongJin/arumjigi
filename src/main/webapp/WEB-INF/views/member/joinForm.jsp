...
<body>
        ...
        <section id="content">
            ...
            <article>
                <h3>회원정보 입력</h3>
                <form name="join_form" action="arumjigi.com?type=join" method="post">
                    <div class="inputItem">
                    ...
                    <div class="inputItem">
                        ...
                        <ul id="email_list">
                            <li>
                                <input type="radio" id="maileuse1" name="maileuse" checked
                                class="email">
                                <label for="maileuse1" class="mailLabel">수신</label>
                            </li>
                            <li>
                                <input type="radio" id="maileuse2" name="maileuse">
