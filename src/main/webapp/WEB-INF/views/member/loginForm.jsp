...
<body>
        ...
        <section id="content">
            ...
            <h2>로그인</h2>
                <div class="boxTitle">
                    <h3>안녕하세요.<br><strong>(재)아름지기 홈페이지</strong>에 오신 것을 환영합니다.</h3>
                ...
                <article>
                    <div class="boxLogin">
                        <ul class="table">
                            ...
                            <li><a href="./login_guest.html">비회원 주문조회</a></li>
                        </ul>
                        <form method="post" action="${contextPath}/member/login.com">
                            <fieldset>
                                <div class="inputItem">
                                ...
                                <ul class="loginUtil">
                                    ...
                                    <li><a href="./search_id.html">아이디 찾기</a></li>
                                    <li><a href="./search_pwd.html">비밀번호 찾기</a></li>
                                </ul>
                            </fieldset>
                        </form>
                    </div>
